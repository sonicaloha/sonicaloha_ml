...
try:
    from aloha_scripts.robot_utils import Recorder, ImageRecorder  # gnq  add aloha_scripts.
    from aloha_scripts.robot_utils import setup_master_bot, setup_puppet_bot, move_arms, move_grippers # gnq
except ImportError:
    from robot_utils import Recorder, ImageRecorder  # gnq  add aloha_scripts.
    from robot_utils import setup_master_bot, setup_puppet_bot, move_arms, move_grippers # gnq
...
class RealEnv:
    ...
    def step(self, action):
        ...
        # print("the action is", action)# @gnq
        # input("Enter to continue the action")
